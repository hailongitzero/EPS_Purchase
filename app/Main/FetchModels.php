...
class FetchModels
{
    ...
    /**
     * @var Builder|MdModels
     */
    private $query;

    /**
     * @param MdModels $entry
     */
    public function __construct(MdModels $models)
    {
        $this->models = $models;
    }
    ...
    public function execute($params)
    {
        ...
        $params['with'] = 'manufacturer,categories,depreciation';
        $paginator = (new Paginator($this->models, $params));
