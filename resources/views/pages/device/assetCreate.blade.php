...
<div class="box p-5 mt-5">
    <form id="frm_insertAssets" action="{{ url('asset-insert') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        <div class="flex flex-col-reverse xl:flex-row flex-col box ">
            <div class="flex-1 mt-6 xl:mt-0">
                <div class="grid grid-cols-12 gap-2 mt-5 p-5">
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        ...
                        <input id="asset-tag" name="asset-tag" type="text" class="form-control w-full" placeholder="Thẻ tài sản">
                    </div>
                    <div class="col-span-12 lg:col-span-6">
                        <label for="serial" class="form-label">Serial</label>
                        <input id="serial" name="serial" type="text" class="form-control w-full" placeholder="Serial">
                    </div>
                    <div class="col-span-12 lg:col-span-6">
                        <label for="model" class="form-label">Model <span class="text-theme-24">(*)</span></label>
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        <div class="sm:grid grid-cols-3 gap-2">
                            ...
                            <div class="input-group">
                                <input id="quantity" type="number" name="quantity" class="form-control" placeholder="Số lượng" required>
                                <div class="">
                                    <select id="unit" name="unit" data-placeholder="" class="tail-select w-full" required>
                                        <option value="1">Cái</option>
                                        <option value="2">Bộ</option>
                                        <option value="3">Sợi</option>
                                        <option value="4">Mét</option>
                                    </select>
                                </div>
                            </div>
                            <div class="input-group mt-2 sm:mt-0">
                                <input id="cost" name="cost" type="number" class="form-control" placeholder="Đơn giá" aria-describedby="input-group-4" required>
                        ...
                        <div class="sm:grid grid-cols-3 gap-2">
                            ...
                            <div class="input-group">
                                <div class="relative w-56">
                                    ...
                                    <input id="purchase_dt" name="purchase_dt" type="text" class="datepicker form-control pl-12" placeholder="Ngày mua" data-single-mode="true" required>
                                </div>
                            </div>
                            <div class="input-group">
                                <input id="warranty" name="warranty" type="number" class="form-control" placeholder="Bảo hành" aria-describedby="input-group-4">
                                <div class="input-group-text">Tháng</div>
                            </div>
                            <div class="input-group">
                                <div class="form-check">
                                    <input id="requestable" name="requestable" class="form-check-switch" type="checkbox">
            ...
            <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5">
                    <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                        <img class="asset-img rounded-md" alt="" src="{{url('storage/placeholders/200x200.jpg')}}">
                    </div>
