...
<div class="box p-5 mt-5">
    <form id="frm_insertAssets" action="{{ url('asset-clone') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="flex-1 mt-6 xl:mt-0">
                <div class="grid grid-cols-12 gap-2 mt-5 p-5">
                    ...
                    <div class="col-span-12 lg:col-span-12 text-right mt-5">
                        <button id="btn_cloneAsset" type="submit" class="btn btn-primary w-24">Lưu</button>
                    </div>
                </div>
            </div>
            <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                <div class="border-2 border-dashed shadow-sm border-gray-200 dark:border-dark-5 rounded-md p-5">
                    <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                        ...
                        <input id="clone_asset_img" name="clone_asset_img" type="text" value="{{$asset->image}}">
                    </div>
