...
<div class="pos grid grid-cols-12 gap-5 mt-5">
    ...
    <div class="col-span-12 lg:col-span-8">
        ...
        <div class="post box mt-4">
            <div class="manage_request post__tabs nav nav-tabs flex-col sm:flex-row bg-gray-300 dark:bg-dark-2 text-gray-600" role="tablist">
                <a title="Tất cả yêu cầu" data-toggle="tab" data-target=".all_request" href="javascript:;" class="tooltip w-full sm:w-40 py-4 text-center flex flex-col justify-center items-center" id="all-req-tab" role="tab" aria-selected="false">
                    <div>
                ...
                <a title="Danh sách yêu cầu mới" data-toggle="tab" data-target=".new_requests" href="javascript:;" class="tooltip w-full sm:w-40 py-4 text-center flex flex-col justify-center items-center active" id="new-req-tab" role="tab" aria-controls="content" aria-selected="true">
                    <div>
                        <i data-feather="file-text" class="w-4 h-4"></i> YC mới
                    </div>
                    <span id="new_requests_tab_sum" class="px-2 py-1 rounded-full bg-theme-9 text-white"></span>
                </a>
            ...
            <div class="post__content tab-content">
                <div id="all_request" class="all_request tab-pane" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                            <form id="all-request-table-html-filter-form" class="xl:flex sm:ml-auto">
                                <div class="flex-1 relative sm:flex items-center mr-4">
                                    <select id="all-request-table-html-department" name="all-request-table-html-department" class="tail-select w-full" data-search=true>
                                ...
                                <div class="flex-1 relative sm:flex items-center mr-4">
                                    <select id="all-request-table-html-request-tp" name="all-request-table-html-request-tp" class="tail-select w-full" data-search=true>
                ...
                <div id="new_requests" class="new_requests tab-pane active" role="tabpanel" aria-labelledby="content-tab">
                    <div class="box p-5 mt-5">
                        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                            <form id="new-requests-table-html-filter-form" class="xl:flex sm:ml-auto">
                                <div class="flex-1 relative sm:flex items-center mr-4">
                                    <select id="new-requests-table-html-department" class="tail-select w-full" data-search=true>
                                        <option value="" data-cc-mail-check="0">---Chọn phòng ban---</option>
                                        @foreach( $deptUser as $dept )
                                        <option value="{{ $dept->department_id }}">{{ $dept->department_name }}</option>
                                        @endforeach
                                ...
                                <div class="flex-1 relative sm:flex items-center mr-4">
                                    <select id="new-requests-table-html-request-tp" class="tail-select w-full" data-search=true>
                                        <option value="" data-cc-mail-check="0">---Chọn loại yêu cầu---</option>
                                        @foreach( $requestTp as $tp )
                                        <option value="{{ $tp->request_type }}" data-cc-mail-check="{{ $tp->cc_mail_check }}">{{ $tp->type_name }}</option>
                                        @endforeach
                                ...
                                <div class="flex-1 relative sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                    <input id="new-requests-table-html-filter-value" type="text" class="form-control form-control-rounded w-64" placeholder="Tiêu đề...">
                                    <i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0" data-feather="search"></i>
                                </div>
                            </form>
                        </div>
                        <div class="overflow-x-auto scrollbar-hidden">
                            <div id="new-requests-table" class="mt-5 table-report table-report--tabulator"></div>
                            <div><p class="text-center"><span class="total_new_result">0</span>/<span class="total__new_request">{{$totalNewRequest}}</span> Tổng số yêu cầu</p></div>
                        </div>
                    </div>
                </div>
    ...
    <div id="request-info" class="col-span-12 lg:col-span-4 post__content tab-content">
        ...
        <div class="all_request tab-pane box mt-4" role="tabpanel" aria-labelledby="content-tab">
        ...
        <div class="new_requests tab-pane box mt-4 active" role="tabpanel" aria-labelledby="content-tab">
            <div class="grid grid-cols-12 p-5">
                ...
                <div class="col-span-12 xxl:col-span-6 border-b border-gray-200 mt-3 pb-3">
                    <label class="form-label font-medium">Hạn xử lý</label>
                    <input class="dpk_complete_dt datepicker form-control block mx-auto" data-id="dpk_complete_dt" data-single-mode="true">
                </div>
                <div class="col-span-12 xxl:col-span-6 border-b border-gray-200 mt-3 pb-3">
                    <label class="form-label font-medium">Điện thoại</label>
                    <p class="txt_telephone"></p>
                ...
                <div class="col-span-12 xxl:col-span-6 border-b border-gray-200 mt-3 pb-3">
                    <label class="form-label font-medium">Loại yêu cầu</label>
                    <select class="cbx_request_tp tail-select" data-id="cbx_request_tp">
                        @foreach($requestTp as $tp)
                ...
                <div class="col-span-12 border-b scope border-gray-200 mt-3 pb-3">
                    <label class="form-label font-medium">Cc mail</label>
                    <p class="txt_cc_mail line-break"></p>
                </div>
                <div class="col-span-12 border-b border-gray-200 mt-3 pb-3">
                    <div id="req-accordion-2" class="accordion">
                        <div class="accordion-item">
                            <div id="req-accordion-content-1" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-1" aria-expanded="true" aria-controls="faq-accordion-collapse-1"> Nội dung yêu cầu </button>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div id="req-accordion-content-2" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-2" aria-expanded="true" aria-controls="faq-accordion-collapse-2"> Giao việc </span> </button>
                            </div>
                            <div id="req-accordion-collapse-2" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-2" data-bs-parent="#faq-accordion-2">
                                <div class="accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                    <div id="assign_content" name="ckAssignContent" class="editor"></div>
                                    <div class="grid grid-cols-12 pt-5">
                                        <div class="col-span-12 xxl:col-span-6">
                                            <select class="cbx_handler tail-select w-full" data-id="cbx_handler">
                                                <option value="">Chọn người xử lý</option>
                                                @foreach ($moderator as $mod)
                                                <option value="{{ $mod->username }}">{{ $mod->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-span-12 xxl:col-span-6"><button class="btn-add-handler btn p-2 ml-2 box border border-gray-400 text-gray-700 dark:text-gray-300" aria-expanded="true"><span class="w-5 h-5 flex items-center justify-center"><i class="w-4 h-4" data-feather="plus"></i></span></button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu w-48">
                            <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                <a href="#" class="btn_assign flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
        ...
        <div class="handle_request tab-pane box mt-4" role="tabpanel" aria-labelledby="content-tab">
            <div class="grid grid-cols-12 p-5">
                ...
                <div class="col-span-12 xxl:col-span-6 border-b border-gray-200 mt-3 pb-3">
                    <label class="form-label font-medium">Xử lý</label>
                ...
                <div class="col-span-12 border-b border-gray-200 mt-3 pb-3">
                    <div id="req-accordion-3" class="accordion">
                        <div class="accordion-item">
                            <div id="req-accordion-content-1" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-1" aria-expanded="true" aria-controls="faq-accordion-collapse-1"> Nội dung yêu cầu </button>
                            </div>
                            <div id="req-accordion-collapse-1" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-1" data-bs-parent="#req-accordion-3">
                                <div class="acd_request_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-2" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-2" data-bs-parent="#req-accordion-3">
                                <div class="acd_request_assign_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-3" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-3" data-bs-parent="#req-accordion-3">
                                <div class="acd_request_handler_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-4" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-4" data-bs-parent="#req-accordion-3">
                                <div class="acd_request_sub_hander_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
        ...
        <div class="extend_return_request tab-pane box mt-4" role="tabpanel" aria-labelledby="content-tab">
            <div class="grid grid-cols-12 p-5">
                ...
                <div class="col-span-12 border-b border-gray-200 mt-3 pb-3">
                    <div id="req-accordion-4" class="accordion">
                        <div class="accordion-item">
                            <div id="req-accordion-content-1" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-1" aria-expanded="true" aria-controls="req-accordion-collapse-1"> Nội dung yêu cầu </button>
                            </div>
                            <div id="req-accordion-collapse-1" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-1" data-bs-parent="#req-accordion-4">
                                <div class="acd_request_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-2" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-2" data-bs-parent="#req-accordion-4">
                                <div class="acd_request_assign_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div id="req-accordion-content-3" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-3" aria-expanded="true" aria-controls="req-accordion-collapse-3"> Người chuyển: <span class="txt_handler"></span></button>
                            </div>
                            <div id="req-accordion-collapse-3" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-3" data-bs-parent="#req-accordion-4">
                                <div class="acd_request_handler_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div id="req-accordion-content-3" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-3" aria-expanded="true" aria-controls="req-accordion-collapse-3"> Gia hạn: <span class="txt_handler"></span></button>
                            </div>
                            <div id="req-accordion-collapse-3" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-3" data-bs-parent="#req-accordion-4">
                                <div class="acd_request_extend_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div id="req-accordion-content-2" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-2" aria-expanded="true" aria-controls="req-accordion-collapse-2"> Chuyển xử lý </button>
                            </div>
                            <div id="req-accordion-collapse-2" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-2" data-bs-parent="#req-accordion-4">
                                <div class="accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                    <div id="assign_content" name="ckReturnAssignContent" class="editor"></div>
                                    <div class="grid grid-cols-12 pt-5">
                                        <div class="col-span-12 xxl:col-span-6">
                                            <select class="cbx_handler tail-select w-full" data-id="cbx_handler">
                                                <option value="">Chọn người xử lý</option>
                ...
                <div class="col-span-12 border-b border-gray-200 mt-3 pb-3"><label class="form-label font-medium">Đính kèm</label>
                    <div class="txt_attachment"></div>
                </div>
                <div class="flex flex-wrap col-span-12 border-gray-200 mt-3 pb-3">
                    <a class="btn-accept-extend btn btn-warning w-32 mr-2 mb-2 hidden"> Đồng ý </a>
                    <a class="btn-deny-extend btn btn-danger w-32 mr-2 mb-2 hidden"> Từ chối </a>
                    <div class="drd-handle-request dropdown hidden">
                        <button id="btn-dropdown-handle-return-request" class="dropdown-toggle btn btn-primary" aria-expanded="true">Xử lý yêu cầu</button>
                        <div class="dropdown-menu w-48">
                            <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                <a href="#" class="btn_assign flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
                                    <i data-feather="navigation" class="w-4 h-4 mr-2"></i> Chuyển xử lý </a>
        ...
        <div class="my_request tab-pane box mt-4" role="tabpanel" aria-labelledby="content-tab">
            <div class="grid grid-cols-12 p-5">
                ...
                <div class="col-span-12 border-b border-gray-200 mt-3 pb-3">
                    <div id="req-accordion-6" class="accordion">
                        <div class="accordion-item">
                            <div id="req-accordion-content-1" class="accordion-header">
                                <button class="accordion-btn" type="button" data-bs-toggle="collapse" data-bs-target="#req-accordion-collapse-1" aria-expanded="true" aria-controls="req-accordion-collapse-1"> Nội dung yêu cầu </button>
                            </div>
                            <div id="req-accordion-collapse-1" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-1" data-bs-parent="#req-accordion-6">
                                <div class="acd_request_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-2" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-2" data-bs-parent="#req-accordion-6">
                                <div class="acd_request_assign_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-3" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-3" data-bs-parent="#req-accordion-6">
                                <div class="acd_request_handler_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="req-accordion-collapse-4" class="accordion-collapse collapse show" aria-labelledby="req-accordion-content-4" data-bs-parent="#req-accordion-6">
                                <div class="acd_request_sub_hander_content accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                                </div>
                            </div>
                        </div>
...
<!-- BEGIN: Modal Content -->
<div id="modal_preview" class="modal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content"> <a data-dismiss="modal" href="javascript:;"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
            <div class="modal-body p-0">
                <div class="p-10 text-center">
                    <div id="view_editor" data-content="" data-editor="balloon" data-status="readOnly" class="editor"></div>
                </div>
...
<!-- BEGIN: Modal Content -->
<div id="modal_edit" class="modal" data-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content"> <a data-dismiss="modal" href="javascript:;"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
            <div class="modal-body p-0">
                <div class="p-10 text-center">
                    <div id="edit_editor" data-content="" class="editor"></div>
                </div>
                <div class="pb-8 text-center">
                    <button type="button" data-dismiss="modal" class="close_modal_edit btn btn-primary w-24">Ok</button>
                </div>
            </div>
        </div>
    </div>
