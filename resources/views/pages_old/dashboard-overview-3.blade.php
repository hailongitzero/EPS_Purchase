        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 xl:col-span-9 xxl:col-span-9 z-10">
                <div class="mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box bg-theme-14 text-white flex items-center mb-6" role="alert">
                        <span>
                ...
                <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                        ...
                        <div class="xxl:flex mt-5 mb-3">
                            ...
                            <div class="mt-5 xxl:flex xxl:justify-center xxl:mt-0 xxl:-ml-20 xxl:w-14 xxl:flex-none xxl:pl-1">
                                <div class="font-medium inline-flex bg-theme-10 text-white rounded-full px-2 py-1 text-xs xxl:text-sm xxl:p-0 xxl:text-theme-10 xxl:bg-transparent xxl:flex items-center tooltip cursor-pointer xxl:justify-center" title="49% Higher than last month">
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 border-black border-opacity-10 border-t sm:border-t-0 border-l md:border-l-0 border-dashed -ml-4 pl-4 md:ml-0 md:pl-0">
                        <div class="boxed-tabs nav nav-tabs justify-center w-3/4 xxl:w-4/6 bg-theme-7 bg-opacity-50 text-gray-600 dark:bg-dark-2 dark:text-gray-500 rounded-md p-1 mx-auto" role="tablist">
                ...
                <div class="grid grid-cols-12 gap-6 relative intro-y">
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 xxl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            ...
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-7 bg-opacity-90 dark:bg-dark-5 text-gray-700 dark:text-gray-300 cursor-pointer truncate">180 Campaign</div>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 xxl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            ...
                            <a href="" class="flex items-center text-theme-26 dark:text-theme-33">
                    ...
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 xxl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            ...
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-7 bg-opacity-90 dark:bg-dark-5 text-gray-700 dark:text-gray-300 cursor-pointer truncate">320 Followers</div>
                        </div>
                        <div class="px-10 sm:px-0">
        ...
        <div class="report-box-4 w-full h-full grid grid-cols-12 gap-6 xl:absolute -mt-8 xl:mt-0 pb-6 xl:pb-0 top-0 right-0 z-30 xl:z-auto">
            <div class="col-span-12 xl:col-span-3 xl:col-start-10 xl:pb-16 z-30">
                <div class="h-full flex flex-col">
                    <div class="box p-5 mt-6 bg-theme-14 intro-x">
                        ...
                        <div class="max-h-full xl:overflow-y-auto box mt-5">
                            <div class="bg-white dark:bg-dark-3 xl:sticky top-0 px-5 pt-5 pb-6">
                                ...
                                <div class="boxed-tabs nav nav-tabs justify-center border border-gray-400 border-dashed text-gray-600 dark:border-gray-700 dark:bg-dark-3 dark:text-gray-500 rounded-md p-1 mt-5 mx-auto" role="tablist">
                                    <a data-toggle="tab" data-target="#active-users" href="javascript:;" class="btn flex-1 border-0 shadow-none py-1 px-2 active" id="active-users-tab" role="tab" aria-controls="active-users" aria-selected="true">Weekly</a>
                                    <a data-toggle="tab" data-target="#inactive-users" href="javascript:;" class="btn flex-1 border-0 shadow-none py-1 px-2" id="inactive-users-tab" role="tab" aria-selected="false">Monthly</a>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane active grid grid-cols-12 gap-y-6" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                    ...
                                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                                        ...
                                        <div class="mt-1.5 flex items-center">
                                            ...
                                            <div class="text-theme-10 flex text-xs font-medium tooltip cursor-pointer ml-2" title="0.1% Lower than last month">
                                                49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                @foreach (array_slice($fakers, 0, 4) as $faker)
                                    <tr class="intro-x">
                                        ...
                                        <td class="w-40">
                                            <div class="flex items-center justify-center {{ $faker['true_false'][0] ? 'text-theme-10' : 'text-theme-24' }}">
                            ...
                            @foreach (array_slice($fakers, 0, 5) as $faker)
                                <div class="intro-x">
                                    <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="{{ $faker['true_false'][0] ? 'text-theme-10' : 'text-theme-24' }}">{{ $faker['true_false'][0] ? '+' : '-' }}${{ $faker['totals'][0] }}</div>
                                    </div>
                                </div>
                            @endforeach
